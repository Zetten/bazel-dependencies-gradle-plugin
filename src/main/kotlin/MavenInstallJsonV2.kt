...
internal typealias MavenInstallJsonV2ArtifactKey = String
internal typealias MavenInstallJsonV2ArtifactKeyWithClassifier = String
internal typealias MavenInstallJsonV2RepoUrl = String
    ...
    abstract class GenerateMavenInstallV2Snippet : WorkAction<GenerateMavenInstallV2SnippetParams> {
        override fun execute() {
            ...
            val mavenInstallV2Snippet = MavenInstallJsonV2Snippet(
                ...
                classifier = dependency.id.classifier,
                classifierShasums = classifierShasums,
                dependencies = dependency.dependencies.map { coordToKey(it.getRulesJvmExternalCoordinates()) }.sorted(),
...
internal data class MavenInstallJsonV2Contents(
    @JsonProperty("__AUTOGENERATED_FILE_DO_NOT_MODIFY_THIS_FILE_MANUALLY", index = 0)
    val oldDependencyTreeSignature: Any = "THERE_IS_NO_DATA_ONLY_ZUUL",
    @JsonProperty("__INPUT_ARTIFACTS_HASH", index = 1)
    val inputArtifactsHash: Int,
    @JsonProperty("__RESOLVED_ARTIFACTS_HASH", index = 2)
    val resolvedArtifactsHash: Int,
    @JsonProperty("artifacts", index = 3)
    val artifacts: Map<MavenInstallJsonV2ArtifactKey, MavenInstallJsonV2Artifact>,
    @JsonProperty("dependencies", index = 4)
    @JsonInclude(content = JsonInclude.Include.NON_EMPTY)
    val dependencies: Map<MavenInstallJsonV2ArtifactKeyWithClassifier, List<MavenInstallJsonV2ArtifactKeyWithClassifier>>,
    @JsonProperty("skipped", index = 5)
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    val skipped: List<MavenInstallJsonV2ArtifactKey>?,
    @JsonProperty("packages", index = 6)
    @JsonInclude(content = JsonInclude.Include.NON_EMPTY)
    val packages: Map<MavenInstallJsonV2ArtifactKey, List<String>>,
    @JsonProperty("repositories", index = 7)
    val repositories: Map<MavenInstallJsonV2RepoUrl, List<MavenInstallJsonV2ArtifactKeyWithClassifier>>,
    @JsonProperty("version", index = 8)
...
internal data class MavenInstallJsonV2Artifact(
    @JsonProperty("shasums") val shasums: Map<String, String?>,
    @JsonProperty("version") val version: String
)

private data class MavenInstallJsonV2Snippet(
    val groupId: String,
