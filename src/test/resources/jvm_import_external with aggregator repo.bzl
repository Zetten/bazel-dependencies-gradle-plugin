...
alias(
    name = "com_google_code_findbugs_jsr305_neverlink",
    actual = "@com_google_code_findbugs_jsr305_neverlink",
    visibility = ["//visibility:public"],
)
...
alias(
    name = "com_google_errorprone_error_prone_annotations_neverlink",
    actual = "@com_google_errorprone_error_prone_annotations_neverlink",
    visibility = ["//visibility:public"],
)

alias(
    name = "com_google_guava_failureaccess",
    actual = "@com_google_guava_failureaccess",
    visibility = ["//visibility:public"],
)

alias(
    name = "com_google_guava_failureaccess_neverlink",
    actual = "@com_google_guava_failureaccess_neverlink",
    visibility = ["//visibility:public"],
)
...
alias(
    name = "com_google_guava_guava_neverlink",
    actual = "@com_google_guava_guava_neverlink",
    visibility = ["//visibility:public"],
)

alias(
    name = "com_google_guava_listenablefuture",
    actual = "@com_google_guava_listenablefuture",
    visibility = ["//visibility:public"],
)

alias(
    name = "com_google_guava_listenablefuture_neverlink",
    actual = "@com_google_guava_listenablefuture_neverlink",
    visibility = ["//visibility:public"],
)
...
alias(
    name = "com_google_j2objc_j2objc_annotations_neverlink",
    actual = "@com_google_j2objc_j2objc_annotations_neverlink",
    visibility = ["//visibility:public"],
)

alias(
    name = "org_checkerframework_checker_qual",
    actual = "@org_checkerframework_checker_qual",
    visibility = ["//visibility:public"],
)

alias(
    name = "org_checkerframework_checker_qual_neverlink",
    actual = "@org_checkerframework_checker_qual_neverlink",
    visibility = ["//visibility:public"],
)
"""
